...
def consolidate(volley, session, include_episode, guidance=''):
    ...
    prompt = ('You maintain the long-term memory of Moxie, a robot friend of a child. '
              ...
              'or obsolete. Record what HAPPENED, neutrally - NEVER store advice, warnings, or safety '
              'reminders that Moxie gave as memories. Events inside pretend play, roleplay, or stories '
              'are FICTION - never store them as real facts about the child; at most store that the '
              'child enjoyed the game or character. Only store things the child said, did, or clearly '
              'confirmed with real enthusiasm - never topics Moxie itself introduced that got only '
              'polite agreement. ' + (guidance + ' ' if guidance else '') +
